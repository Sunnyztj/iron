...
})(window,document,'script','dataLayer','GTM-P52H9HT');</script>
<!-- End Google Tag Manager -->
	...
	<script>
		var exclude_length = document.getElementById('top').firstChild.length;
		if (exclude_length == 5 || exclude_length == 6) {
